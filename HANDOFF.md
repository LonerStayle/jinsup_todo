...
- ✅ 사이드바 selected 상태에 키보드 focus ring — SidebarItem (InkWell.onFocusChange + BorderSide outline) (commit pending)

총 193/193 PASS.

다음: § 10-C 네번째 — Snackbar undo 시간 시각 표시 (5초 progress bar).
